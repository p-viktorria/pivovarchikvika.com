    ...
    <div class="col-xs-12" style="margin-top: -180px">
        ...
        <form style="margin-left: 150px;" class="form-horizontal" action="" id="form" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" value="<?php echo $blog['title'];?>" name="title" id="form-field-1" placeholder="Заглавие" class="col-xs-10 col-sm-5" />
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <textarea  name="preview"><?php echo $blog['preview'];?></textarea>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <textarea  name="text"><?php echo $blog['text'];?></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" value="<?php echo $blog['author'];?>" name="author" id="form-field-1" placeholder="ФИО" class="col-xs-10 col-sm-5" />
                </div>
                <div class="space-4"></div>
            </div>
            ...
            <input style="margin-left: 360px" type="submit" name="submit"  value="Обновить статью" class="btn btn-success">
