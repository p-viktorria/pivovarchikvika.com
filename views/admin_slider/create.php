    ...
    <div class="col-xs-12" style="margin-top: -180px">
        ...
        <form style="margin-left: 150px;" class="form-horizontal" action="" id="form" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="h1" id="form-field-1" placeholder="Наименование" class="col-xs-10 col-sm-5" />
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="h2" id="form-field-1" placeholder="Наименование" class="col-xs-10 col-sm-5" />
                </div>
                <div class="space-4"></div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="p" id="form-field-1" placeholder="Наименование" class="col-xs-10 col-sm-5" />
                </div>
                <div class="space-4"></div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="href" id="form-field-1" placeholder="Наименование" class="col-xs-10 col-sm-5" />
                </div>
                <div class="space-4"></div>
            </div>
            ...
            <input style="margin-left: 360px" type="submit" name="submit"  value="Добавить страницу" class="btn btn-success">
