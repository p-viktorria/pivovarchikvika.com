        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-9 padding-right">
                    <?php if(isset($productsBySearch)):?>
                    <div class="features_items"><!--features_items-->
                        <h2 class="title text-center">Представлены последние результаты (<?php echo count($productsBySearch);?>) </h2>
                        <?php if ((count($productsBySearch)) < 1):?>
                                    <h3>Ваш поиск не дал результатов</h3>
                        <?php endif;?>
                        <?php foreach($productsBySearch as $product): ?>
                            <div class="col-sm-4">
