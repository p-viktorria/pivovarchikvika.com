        ...
        <div class="col-xs-12" style="margin-top: -180px">
            ...
            <form style="margin-left: 150px;" class="form-horizontal" action="" id="form" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group" >
                    ...
                    <select disabled name="name"  class="col-xs-4 col-sm-2" id="form-field-select-1">

                        <?php foreach ($products as $product):?>
                            <option  value="<?php echo $product['id_book'];?>"  <?php if($id_book == $product['id_book'])echo 'selected'?>>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input class="input-sm" value="<?php echo $quantityBook;?>" name="quantity" type="text" id="form-field-4" placeholder="" />
