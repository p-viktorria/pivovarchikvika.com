        ...
        <div class="col-xs-12" style="margin-top: -180px">
            ...
            <form style="margin-left: 150px;" class="form-horizontal" action="" id="form" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" value="<?php echo $category['name'];?>" name="name" id="form-field-1" placeholder="Наименование" class="col-xs-10 col-sm-5" />
                    </div>
                ...
                <div class="form-group" >
                    ...
                    <select name="status"  class="col-xs-3 col-sm-1" id="form-field-select-1">
                        <option value="<?php echo $category['status'];?>"><?php if($category['status'] == 1){echo 'Отображается';}else{ echo 'Не отображается';}?></option>
